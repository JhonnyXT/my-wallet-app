// COPIA GENERADA de src/utils/voiceParser.ts por landing/scripts/sync-app-logic.sh.
 ...
 */
import type { ActiveExpense, DateOption } from "./types";
...
function extractCategory(
  text: string,
  userCats?: import("./categoryPresets").UserCategory[],
  isExpense?: boolean,
